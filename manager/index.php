...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($action == 'create_slot') {
        ...
        $stmt->bind_param("sssii", $_POST['title'], $_POST['slot_date'], $_POST['slot_time'], $duration, $_SESSION['user_id']);
        $stmt->execute();
...
if ($view == 'week') {
    $stmt = $database->prepare(
        "SELECT slot.*, employee.name AS requested_by_name
         FROM slot
    ...
    <div class="table-wrap">
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr><td colspan="6" class="table-empty">No slots yet &mdash; add an available time above.</td></tr>
                <?php endif; ?>
