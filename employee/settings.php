...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($action == 'update_profile') {
        ...
        $stmt->bind_param("sssi", $_POST['name'], $_POST['employee_number'], $_POST['phone'], $_SESSION['user_id']);
        $stmt->execute();
        ...
        $stmt = $database->prepare("SELECT password_hash FROM employee WHERE id = ?");
        ...
        <div class="form-grid">
            ...
            <div>
                ...
                <input type="text" name="employee_number" class="input-text" placeholder="Employee #"
                    value="<?php echo htmlspecialchars($me['employee_number'] ?? ''); ?>">
            </div>
            <div>
